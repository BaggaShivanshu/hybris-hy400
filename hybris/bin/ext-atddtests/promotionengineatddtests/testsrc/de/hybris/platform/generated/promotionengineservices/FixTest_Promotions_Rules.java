	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20180306141615_promotionengine_artifact_develop_719f6f8/prepare/build/source/promotionengineatddtests/genresources/robottests/FixTest_Promotions_Rules.txt"));
		}
