...
public class Mixed_Stackable_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20180306141615_promotionengine_artifact_develop_719f6f8/prepare/build/source/promotionengineatddtests/genresources/robottests/Mixed_Stackable_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Stackable_Promotions_Product_Product_TC_QA_7582()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Stackable_Promotions_Product_Product_TC_QA_7582";
	...
	@Test
	public void Test_Apply_Stackable_Promotions_Product_Product_TC_QA_7639()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Stackable_Promotions_Product_Product_TC_QA_7639";
