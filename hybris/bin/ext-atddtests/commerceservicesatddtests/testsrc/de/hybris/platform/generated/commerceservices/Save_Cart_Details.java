	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20180316151133_commerceservices_artifact_develop/prepare/build/source/commerceservicesatddtests/genresources/robottests/Save_Cart_Details.txt"));
		}
